...
- no config is needed in the WP config file.. only the midleware config.. here WP runs inside our node server. We get all benefits of a separate WP server here as well.
